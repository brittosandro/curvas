...
dados = np.loadtxt('IA_DMSO_EQ_UN_nmove.dat', comments='#')
x = dados[:, 0]
y = dados[:, 1]

dados1 = np.loadtxt('IB_DMSO_EQ_UN_nmove.dat', comments='#')
x1 = dados1[:, 0]
y1 = dados1[:, 1]

dados2 = np.loadtxt('IC_DMSO_EQ_UN_nmove.dat', comments='#')
x2 = dados2[:, 0]
y2 = dados2[:, 1]

dados3 = np.loadtxt('ID_DMSO_EQ_UN_nmove.dat', comments='#')
x3 = dados3[:, 0]
y3 = dados3[:, 1]
