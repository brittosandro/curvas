...
dados = np.loadtxt('IA_DMSO_EQ_D_nmove.dat', comments='#')
x = dados[:, 0]
y = dados[:, 1]

dados1 = np.loadtxt('IB_DMSO_EQ_D_nmove.dat', comments='#')
x1 = dados1[:, 0]
y1 = dados1[:, 1]

dados2 = np.loadtxt('IC_DMSO_EQ_D_nmove.dat', comments='#')
x2 = dados2[:, 0]
y2 = dados2[:, 1]

dados3 = np.loadtxt('IB_DMSO_EQ_D_nmove.dat', comments='#')
x3 = dados3[:, 0]
y3 = dados3[:, 1]
...
fig.subplots_adjust(left=0.100,
...
ax[0, 0].set_ylim(1, 1.21)
ax[0, 0].set_yticks(np.arange(1.0, 1.21, 0.05))
...
ax[0, 1].set_ylim(1, 1.20)
ax[0, 1].set_yticks(np.arange(1.0, 1.21, 0.05))
