...
dados_mol1 = np.loadtxt('IA_DMSO_EQ_D_nmove.dat')
nmove_mol1 = dados_mol1[:, 0]
dens_mol1 = dados_mol1[:, 1]
                    
dados_mol2 = np.loadtxt('IB_DMSO_EQ_D_nmove.dat')
nmove_mol2 = dados_mol2[:, 0]
dens_mol2 = dados_mol2[:, 1]

dados_mol3 = np.loadtxt('IC_DMSO_EQ_D_nmove.dat')
nmove_mol3 = dados_mol3[:, 0]
dens_mol3 = dados_mol3[:, 1]

dados_mol4 = np.loadtxt('ID_DMSO_EQ_D_nmove.dat')
